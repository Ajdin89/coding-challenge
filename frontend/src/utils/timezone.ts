...
const TZ_COUNTRY: Record<string, string> = {
  ...
  'America/Port-au-Prince':'HT','America/Port_of_Spain':'TT','America/Porto_Velho':'BR',
  ...
  'America/Rio_Branco':'BR','America/Santa_Isabel':'MX','America/Santarem':'BR',
  ...
  'America/St_Johns':'CA','America/St_Kitts':'KN','America/St_Lucia':'LC','America/St_Thomas':'VI',
  ...
  'Asia/Kuwait':'KW','Asia/Macau':'MO','Asia/Magadan':'RU','Asia/Makassar':'ID','Asia/Manila':'PH',
  ...
  'Europe/Madrid':'ES','Europe/Malta':'MT','Europe/Mariehamn':'FI','Europe/Minsk':'BY',
  ...
  'Europe/Stockholm':'SE','Europe/Tallinn':'EE','Europe/Tirane':'AL','Europe/Ulyanovsk':'RU',
  'Europe/Uzhgorod':'UA','Europe/Vaduz':'LI','Europe/Vatican':'VA','Europe/Vienna':'AT',
  'Europe/Vilnius':'LT','Europe/Volgograd':'RU','Europe/Warsaw':'PL','Europe/Zagreb':'HR',
  ...
  'Pacific/Guadalcanal':'SB','Pacific/Guam':'GU','Pacific/Honolulu':'US','Pacific/Kiritimati':'KI',
  ...
  'Pacific/Pohnpei':'FM','Pacific/Port_Moresby':'PG','Pacific/Rarotonga':'CK','Pacific/Saipan':'MP',
...
export function getTimezoneCountryCode(tz: string): string | null {
